...
class SettingsScreen(Screen):
    def __init__(self, **kwargs):
        ...
        layout.background_color = (1, 1, 1, 1)  # Fundo branco
        
        # Título
        title_label = Label(text="Configurações", font_size=30, size_hint=(1, None), height=50, color=(0, 0, 0, 1))
        layout.add_widget(title_label)
        
        # Foto de perfil e botão para editar
        profile_layout = BoxLayout(orientation='horizontal', size_hint=(1, 0.3))
        self.profile_image = Image(source="C:\\Users\\lulusinha\\Downloads\\gato 8.jpg", size_hint=(None, None), size=(100, 100), allow_stretch=True)
        self.edit_profile_button = Button(text="Editar Foto", size_hint=(0.3, None), height=50, background_color=(1, 0.8, 0.8, 1), font_size=16)
        ...
        self.language_spinner = Spinner(text='Português', values=('Português', 'Inglês', 'Espanhol'), size_hint=(0.3, None), height=50, background_color=(1, 0.8, 0.8, 1), font_size=16)
        ...
        for text in ["Notificações", "Privacidade", "Conta"]:
            button = Button(text=text, size_hint=(1, None), height=50, background_color=(1, 0.8, 0.8, 1), font_size=16)
            buttons_layout.add_widget(button)
        layout.add_widget(buttons_layout)
        
        # Botão Voltar
        back_button = Button(text="Voltar", size_hint=(1, 0.1), background_color=(1, 0.8, 0.8, 1), font_size=16)
...
class MainScreen(Screen):
    def __init__(self, **kwargs):
        ...
        layout.add_widget(Label(text="Reencontre.me", font_size=40, size_hint=(1, 0.8), color=(0, 0, 0, 1)))
        
        settings_button = Button(text="Configurações", size_hint=(1, 0.2), background_color=(1, 0.8, 0.8, 1), font_size=20)
